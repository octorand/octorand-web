...
export class CollectionMarketPage implements OnInit, OnDestroy {
  ...
  initStore() {
    ...
    this.selectedGen = store.market_gen;
    this.selectedSort = store.market_sort;
    this.selectedBadges = store.market_badges;
  }
  ...
  changeGen(gen: number) {
    ...
    this.currentPage = 1;
    this.refreshView();
    this.storeHelper.setMarketGen(this.selectedGen);
  }
  ...
  changeSort(sort: string) {
    ...
    this.currentPage = 1;
    this.refreshView();
    this.storeHelper.setMarketSort(this.selectedSort);
  }
  ...
  changeBadge(badge: string) {
    ...
    this.currentPage = 1;
    this.refreshView();
    this.storeHelper.setMarketBadges(this.selectedBadges);
  }
